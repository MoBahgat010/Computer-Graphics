...
class StoryBeginningState: public our::State {
    ...
    void playCurrentSlideVoice() {
        ...
        if(!backgroundMusic.play(musicPaths[index], 0.85f)) {
            (void)backgroundMusic.play("assets/audio/storyBeginning/start-1.mp3", 0.85f);
        }
    }
    ...
    void onInitialize() override {
      ...
      const std::vector<std::string> slidePaths = {
            "assets/images/storyBeginning/start-1.jpeg",
            "assets/images/storyBeginning/start-2.jpeg",
            "assets/images/storyBeginning/start-3.png",
            "assets/images/storyBeginning/start-4.jpeg",
            "assets/images/storyBeginning/start-5.jpeg",
            "assets/images/storyBeginning/start-6.jpeg",
            "assets/images/storyBeginning/start-7.jpeg",
            "assets/images/storyBeginning/start-8.jpeg",
            "assets/images/storyBeginning/start-9.jpeg",
            "assets/images/storyBeginning/start-10.jpeg"
        };

        musicPaths = {
            "assets/audio/storyBeginning/start-1.mp3",
            "assets/audio/storyBeginning/start-2.mp3",
            "assets/audio/storyBeginning/start-3.mp3",
            "assets/audio/storyBeginning/start-4.mp3",
            "assets/audio/storyBeginning/start-5.mp3",
            "assets/audio/storyBeginning/start-6.mp3",
            "assets/audio/storyBeginning/start-7.mp3",
            "assets/audio/storyBeginning/start-8.mp3",
            "assets/audio/storyBeginning/start-9.mp3",
            "assets/audio/storyBeginning/start-10.mp3"
        };
    ...
    void onImmediateGui() override {
        ...
        if(ImGui::Begin("##story_next_button", nullptr, flags)) {
            ...
            if(ImGui::Button("Next", ImVec2(-1.0f, -1.0f))) {
                if(isLastSlide) {
