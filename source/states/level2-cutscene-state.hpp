...
class Level2CutsceneState: public our::State {
    ...
    void onInitialize() override {
      ...
      const std::vector<std::string> slidePaths = {
            "assets/images/storyMid/mid-1.jpeg",
            "assets/images/storyMid/mid-2.jpeg",
    ...
    void onImmediateGui() override {
        ...
        if(ImGui::Begin("##story_next_button", nullptr, flags)) {
            ...
            // Allow skipping right to gameplay or moving to next slide
            if(ImGui::Button(isLastSlide ? "Start Level 2" : "Next", ImVec2(-1.0f, -1.0f))) {
                if(isLastSlide) {
